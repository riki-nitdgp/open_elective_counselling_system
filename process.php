...
$bt_sql="SELECT * from registration WHERE valid=1 and semester='fifth' and roll_no like '%bt%' ORDER BY gpa desc";
...
$ce_sql="SELECT * from registration WHERE valid=1 and semester='fifth' and roll_no like '%ce%' ORDER BY gpa desc";
...
$che_sql="SELECT * from registration WHERE valid=1 and semester='fifth' and roll_no like '%ch%' ORDER BY gpa desc";
...
$cse_sql="SELECT * from registration WHERE valid=1 and semester='fifth' and roll_no like '%cs%' ORDER BY gpa desc";
...
$ee_sql="SELECT * from registration WHERE valid=1 and semester='fifth' and roll_no like '%ee%' ORDER BY gpa desc";
...
$ece_sql="SELECT * from registration WHERE valid=1 and semester='fifth' and roll_no like '%ec%' ORDER BY gpa desc";
...
$it_sql="SELECT * from registration WHERE valid=1 and semester='fifth' and roll_no like '%it%' ORDER BY gpa desc";
...
$me_sql="SELECT * from registration WHERE valid=1 and semester='fifth' and roll_no like '%me%' ORDER BY gpa desc";
...
$mme_sql="SELECT * from registration WHERE valid=1 and semester='fifth' and roll_no like '%mm%' ORDER BY gpa desc";
